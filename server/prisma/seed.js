...
async function main() {
  ...
  await prisma.ioc.createMany({
    skipDuplicates: true,
    data: [
      { type: 'ip',     value: '185.10.10.10',                    reputation: 95 },
      { type: 'ip',     value: '45.33.22.11',                     reputation: 82 },
      { type: 'ip',     value: '203.0.113.77',                    reputation: 90 },
      { type: 'ip',     value: '91.108.4.251',                    reputation: 88 },
      { type: 'domain', value: 'malicious-payload.ru',            reputation: 97 },
      { type: 'domain', value: 'phishing-login.net',              reputation: 91 },
      { type: 'domain', value: 'exfil-dropzone.xyz',              reputation: 89 },
      { type: 'domain', value: 'c2-beacon-host.io',               reputation: 94 },
      { type: 'hash',   value: 'a1b2c3d4e5f67890abcdef1234567890', reputation: 98 },
      { type: 'hash',   value: 'e3b0c44298fc1c149afbf4c8996fb924', reputation: 25 },
      { type: 'hash',   value: 'd41d8cd98f00b204e9800998ecf8427e', reputation: 30 },
      { type: 'url',    value: 'http://malicious-payload.ru/drop', reputation: 93 },
    ],
  });
